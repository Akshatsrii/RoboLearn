...
const staticProducts = [
  // Robotics Kits
  {
    ...
    specs: ["Designed for ages 8-11", "Block coding app companion", "10+ guided projects"],
    imageUrl: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=900&q=80",
    price: 2499,
    kitItems: ["Arduino Uno Board", "Ultrasonic Sensor", "2x DC Motors", "Chassis Board", "USB Cable"],
  },
  {
    _id: "2",
    ...
    specs: ["Designed for ages 11-14", "Textual C++ coding intro", "20+ components"],
    imageUrl: "https://images.unsplash.com/photo-1561144257-e32e8efc6c4f?auto=format&fit=crop&w=900&q=80",
    price: 3999,
    kitItems: ["Arduino Uno board", "Breadboard", "Jumper wires (40pcs)", "10x LEDs", "Servo Motor"],
  },
  {
    _id: "3",
    name: "AI Starter Kit",
    ...
    specs: ["Designed for ages 14-18", "Python object detection", "Camera module included"],
    imageUrl: "https://images.unsplash.com/photo-1531747118685-ca8fa6e08806?auto=format&fit=crop&w=900&q=80",
    price: 5499,
    kitItems: ["ESP32 Camera Module", "AI Accelerator Shield", "Connecting wires", "Visual recognition modules"],
  },
  {
    _id: "4",
    ...
    specs: ["Designed for ages 14-18", "WiFi + MQTT broker setups", "Cloud charts guide"],
    imageUrl: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=900&q=80",
    price: 4899,
    kitItems: ["ESP32 Wi-Fi module", "Relay Module (5V)", "Soil Moisture Sensor", "DHT22 Sensor"],
  },
  ...
  },
  {
    ...
    specs: ["Voltage: 12V DC", "Speed: 150 RPM", "Torque: 2 kg-cm"],
    imageUrl: "https://images.unsplash.com/photo-1518640467707-6811f4a6ab73?auto=format&fit=crop&w=900&q=80",
    price: 320,
    kitItems: ["DC Geared Motor"],
  },
  {
    _id: "7",
    ...
    specs: ["Microcontroller: ATmega328P", "Digital I/O Pins: 14", "Analog Inputs: 6"],
    imageUrl: "https://images.unsplash.com/photo-1608564697071-ddf911d81370?auto=format&fit=crop&w=900&q=80",
    price: 650,
    kitItems: ["Arduino Uno R3 Board", "USB cable"],
  },
  {
    _id: "8",
    ...
    specs: ["LCD display screen", "Overload protection", "Probe wires included"],
    imageUrl: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=900&q=80",
    price: 1450,
    kitItems: ["Multimeter unit", "Probes pair", "User guide manual"],
  },
  ...
  // Educational Products
  {
    ...
    specs: ["Scratch 3.0 mapping", "Interactive animations", "Grades 3-8 oriented"],
    imageUrl: "https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&w=900&q=80",
    price: 1999,
    kitItems: ["Access license key", "Download guide booklets"],
  },
  {
    _id: "10",
    ...
    specs: ["Python Tensorflow lite templates", "Webcam object dataset guide", "Hardware integration tutorials"],
    imageUrl: "https://images.unsplash.com/photo-1555255707-c07966088b7b?auto=format&fit=crop&w=900&q=80",
    price: 2999,
    kitItems: ["Software CD license key", "AI code binders (Python)"],
  },
  {
    _id: "11",
    ...
    specs: ["ESP32 dashboard integrations", "Cloud server MQTT configurations", "Step-by-step assembly binds"],
    imageUrl: "https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=900&q=80",
    price: 3499,
    kitItems: ["Curriculum PDF binder", "Source codes zip archive", "Dashboard templates"],
  }
];
