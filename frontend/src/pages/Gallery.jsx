        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-24 text-slate-400">
              ...
              <p className="text-sm mt-2">Upload gallery images from the Admin Dashboard.</p>
            </div>
          ) : filtered.length === 0 ? (
            <div className="text-center py-20 text-slate-500">No photos in this category yet.</div>
          ) : (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {filtered.map((item) => (
