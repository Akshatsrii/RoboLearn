...
import { FileText, Calendar, BookOpen, ArrowRight, Package } from "lucide-react";
import { useAuth } from "../context/AuthContext";

const quickLinks = [
  { icon: Calendar, title: "Book a Consultation", desc: "Request a free lab setup consultation.", path: "/contact" },
    ...
    <div className="min-h-[70vh] bg-slate-50 py-16">
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex items-center gap-4 mb-10">
          <div className="w-14 h-14 rounded-full bg-cyan-50 flex items-center justify-center text-cyan-700 font-bold text-xl">
